  ...
  return (
    <div>
      ...
      <div className="h-1.5 rounded-full bg-[color:var(--color-surface-2)] overflow-hidden">
        <div
          className="h-full rounded-full bg-[color:var(--color-accent)] transition-all duration-1000 ease-out"
          style={{ width: `${level}%` }}
        />
      </div>
    </div>
    ...
    <section className="container-page pt-16 pb-12">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <Reveal className="lg:col-span-2" delay={0}>
          <div className="space-y-5 text-[color:var(--color-text-muted)] leading-relaxed">
      ...
      <div className="grid lg:grid-cols-3 gap-5 mt-16">
        ...
        <Reveal delay={120}>
          <div className="card-surface p-6 lg:col-span-1 h-full">
